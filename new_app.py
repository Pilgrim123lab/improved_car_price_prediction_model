...
if predict_button:
    ...
    st.caption(f"This is a car price prediction app built using Streamlit. The model is trained on a dataset of used cars and can predict the price of a car based on its specifications. For more information about the project, you can visit my GitHub repository or connect with me on LinkedIn: [{linkedin}]({linkedin})")